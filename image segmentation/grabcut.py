...
# setting up flags
rect = (0,0,1,1)
#rect默认为(0,0,1,1) ,(0,0)对应屏幕的左下角位置,(1,1)分别对应屏幕宽的百分比和高的百分比,所以默认相机的rect范围是从左下角到屏幕右上角，即为全屏
...
if __name__ == '__main__':
    ...
    if len(sys.argv) == 2:
        ...
        print("No input image given, so loading default image, D:/PyCharm/wenjian/opencv/ch1/jichu/le.jpg \n")
        print("Correct Usage: python grabcut.py <filename> \n")
        filename = 'D:/PyCharm/wenjian/opencv/ch1/jichu/le.jpg'
